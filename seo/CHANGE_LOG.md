# سجل التعديلات - CHANGE_LOG

- الموقع: شات درر العرب
- الفرع: main — نقطة الرجوع الآمنة: Git (`git -C "C:\Users\Kaz\Documents\GitHub\iraqia-chat" log`).

| التاريخ | التعديل | النطاق | قابل للعكس |
|---|---|---|---|
| 2026-09-18 | صور الغرف + بانر + og:image | img/rooms + الصفحات | نعم (Git) |
| 2026-09-18 | تعديل alt لكل الصور | كل الصفحات | نعم (Git) |
| 2026-09-18 | 6 مقالات + articles.html + صور المقالات | articles/ | نعم (Git) |
